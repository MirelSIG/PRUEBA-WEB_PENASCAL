1. Objetivo: 
Prototipo de Sitio web como propuesta de Peñascal F5 para aplicación innovadora en la Administración Pública en la era de la Revolución Digital. Este protootipo permite a las comunidades autónomas — Euskadi— pasar de políticas reactivas a políticas anticipatorias, donde la IA actúa como un sistema de alerta temprana y como un asistente para la toma de decisiones complejas, siempre bajo supervisión humana y con criterios de equidad, transparencia y protección de datos.
2. Entidades
2. 1 CIUDADANOS dispuestos a proporcionar datos personales mediante firma digital de consentimiento (LOPD-GDD) 
...
3. Simular escenarios: cómo cambia la demanda de ayudas si sube el desempleo, si aumenta la migración, si se encarecen los alquileres o si se implementa una nueva política.
4. Reducir sesgos mediante auditorías algorítmicas y explicabilidad, garantizando que las decisiones se basen en datos y no en percepciones subjetivas.
5. Optimizar recursos públicos asignando apoyos donde generan mayor impacto social y económico.
